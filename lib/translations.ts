export const translations = {
  ...
  ar: {
    ...
    homeDescription: "اكتشفي فساتين صُنعت بحركة شاعرية. كل تصميم من توقيع الرأي مُصمم ومطرز ومفصل يدويًا بدقة، ليضمن أن يكون كل دخول سينمائيًا وكل احتفال لا يُنسى.",
    exploreCollections: "استكشف المجموعات",
    coutureCapsules: "كبسولات الكوتور",
    coutureCapsulesDesc: "استكشف أربع عوالم مميزة من الرأي—كل واحدة مصممة لنوع مختلف من الاحتفالات، من السواريه الحميمة إلى حفلات القاعة الكبرى.",
    ...
    elRaey1Collection: "مجموعة الرأي 1",
    elRaey2Collection: "مجموعة الرأي 2",
    elRaeyTheYardCollection: "مجموعة الرأي ذا يارد",
    ...
    ourStory: "قصتنا",
    aboutHeroDesc: "الرأي هو دار أزياء متخصصة تقدم مجموعة استثنائية من الفساتين المصممة حصرياً للمرأة العصرية والواثقة.",
    newChapter: "عن الرأي",
    newChapterDesc1: "في الرأي، نؤمن بأن كل مناسبة تستحق إطلالة مبهرة تعبر عن شخصيتك الفريدة وتبرز أناقتك الخاصة.",
    ...
    philosophyDesc2: "نحن نتفهم أن التسوق للحصول على الفستان المثالي قد يكون أمراً مربكاً، وهذا السبب يتواجد فريق خدمة العملاء الودود والمطلع لدينا لمساعدتك في كل خطوة على الطريق، سواء كنت بحاجة إلى إرشادات حول المقاس أو التصميم أو أي استفسارات أخرى، فنحن ملتزمون بضمان ألا تكون تجربة التسوق الخاصة بك مع الرأي أقل من استثنائية.",
    ourValues: "قيمنا",
