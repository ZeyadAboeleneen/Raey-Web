export const translations = {
  en: {
    ...
    depositRequiredNotice: "* A deposit is required for rental items to secure your booking.",
    ...
    extraDayBeforeTitle: "Extra Day Before",
    extraDayAfterTitle: "Extra Day After",
    receive1DayEarlier: "Receive 1 day earlier",
    ...
    reviews: "reviews",
    readMore: "Read more",
    selectSizeToRent: "Select Size to Rent",
    selectSizeToBuy: "Select Size to Buy",
    units: "Units",
    cm: "CM",
    inch: "INCH",
    customSizeGuide: "Custom size guide",
    optional: "Optional",
    ...
    subjectOrMessageRequired: "Please provide at least a subject or a message",
    fullName: "Full Name",
  ...
  ar: {
    ...
    depositRequiredNotice: "* يُطلب دفع عربون للعناصر المؤجرة لتأكيد حجزك.",
    ...
    dayBefore: "+1 يوم قبل",
    dayAfter: "+1 يوم بعد",
    extraDayBeforeTitle: "يوم إضافي قبل",
    extraDayAfterTitle: "يوم إضافي بعد",
    receive1DayEarlier: "استلام قبل بيوم",
    ...
    selectSizeToRent: "اختر المقاس للإيجار",
    selectSizeToBuy: "اختر المقاس للشراء",
    units: "وحدات القياس",
    cm: "سم",
    inch: "بوصة",
    customSizeGuide: "دليل المقاسات المخصصة",
    optional: "اختياري",
    ...
    subjectOrMessageRequired: "يرجى إدخال الموضوع أو الرسالة على الأقل",
