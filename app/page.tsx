...
export default function HomePage() {
  ...
  const handleNewsletterSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (!response.ok || (data && data.error)) {
        toast({
          title: t("stayUpdated"),
          description: (data && data.error) || "Failed to subscribe. Please try again.",
        })
        return
      }
  ...
  // Collections shown on the homepage
  const collections = [
    {
      slug: "mona-saleh",
  ...
  const bestSellersRent = useMemo(
    () => bestSellers.filter((p) => p.category !== "sell-dresses"),
    [bestSellers]
  )

  const bestSellersSell = useMemo(
    () => bestSellers.filter((p) => p.category === "sell-dresses"),
    [bestSellers]
  )
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      >
        ...
        {/* Text-based hero content instead of logo */}
        {isHeroLogoVisible && (
          <motion.div
          ...
          >
            ...
            <Button
              ...
              className="bg-rose-400 text-white hover:bg-rose-500 rounded-full px-6 py-3 text-sm sm:text-base inline-flex items-center justify-center"
            >
            ...
            <div className="mt-4 flex justify-center">
              <Button
                ...
                className="border-black text-black hover:bg-black hover:text-white bg-white rounded-full px-6 py-3 sm:py-4 text-xs sm:text-sm group relative overflow-hidden inline-flex items-center justify-center"
              >
      ...
      <motion.section
        ...
        className="py-10 sm:py-12 bg-rose-50 overflow-hidden"
      >
        <div className="container mx-auto px-4 sm:px-6">
          ...
          >
              ...
              <div className="relative inline-flex h-9 sm:h-11 overflow-hidden">
                <AnimatePresence mode="wait">
                  <motion.span
                    ...
                    className="px-3 sm:px-4 text-lg sm:text-2xl md:text-3xl font-semibold bg-gradient-to-r from-rose-500 via-rose-400 to-pink-500 bg-clip-text text-transparent uppercase tracking-[0.35em]"
                  >
                    {currentMood}
                  </motion.span>
                </AnimatePresence>
                  ...
                  return (
                    <button
                      ...
                      className={`px-3 py-1 rounded-full border transition-all duration-200 ${isActive
                        ...
                        : "border-rose-100 text-rose-700/80 hover:border-rose-300 hover:bg-white/70"
                        }`}
                      type="button"
                    >
                      {mood}
            ...
            <motion.p
              className="text-xs sm:text-sm text-rose-900/90 max-w-xl mx-auto"
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
            ...
            >
              <Button
                onClick={scrollToCollections}
                className="bg-white text-rose-600 hover:bg-rose-100 rounded-full px-6 py-3 text-sm sm:text-base inline-flex items-center justify-center relative overflow-hidden group border border-rose-200"
              >
                <span className="relative z-10">Find my dress</span>
                <ArrowRight className="ml-2 h-5 w-5 relative z-10 text-rose-500" />
                <motion.span
                  className="absolute inset-0 bg-gradient-to-r from-rose-100 via-rose-200 to-rose-100 opacity-0 group-hover:opacity-100"
                  initial={{ x: "-100%" }}
                  whileHover={{ x: 0 }}
                  transition={{ duration: 0.2 }}
                />
                      ...
                      <CardContent className="p-0 h-full">
                        ...
                        >
                          <div className="relative w-full aspect-[4/7] sm:aspect-[3/5] overflow-hidden rounded-2xl bg-gray-50">
                            ...
                            <button
                              onClick={(e) => handleFavoriteClick(e as any, product)}
      ...
      <motion.section
        ...
        transition={{ duration: 0.6 }}
        viewport={{ once: true, amount: 0.3 }}
        className="py-16 bg-rose-50 overflow-hidden"
      >
        <div className="container mx-auto px-6">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Explore our curated collections of evening dresses, designed for every special occasion.
            </p>
          </motion.div>
                  ...
                  <CardContent className="p-0 flex flex-col h-full">
                    <div className="relative h-52 sm:h-56 w-full overflow-hidden">
                      ...
                      <div className="absolute inset-x-5 bottom-5 flex items-end justify-between gap-4">
                        <div>
                          <h3 className="text-lg md:text-xl font-light tracking-[0.18em] text-white font-serif mb-1 uppercase">
                            {collection.title}
                          </h3>
                          <p className="text-[11px] md:text-xs text-gray-100/90 line-clamp-2 leading-relaxed">
      ...
      <section className="py-10 md:py-16 bg-rose-50">
        <div className="container mx-auto px-4 sm:px-6">
          <motion.div
            ...
            transition={{ duration: 0.5 }}
            viewport={{ once: true }}
            className="max-w-md mx-auto text-center px-2"
          >
            ...
            <form
              ...
              className="flex flex-col sm:flex-row gap-2 sm:gap-3 w-full max-w-xs sm:max-w-md mx-auto"
            >
              <input
                type="email"
                placeholder={t("yourEmail")}
                className="flex-1 px-4 py-2 sm:py-3 text-sm sm:text-base rounded-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-rose-300 focus:border-transparent"
              ...
              <button
                type="submit"
                className="bg-rose-400 text-white text-sm sm:text-base px-4 sm:px-6 py-2 sm:py-3 rounded-full hover:bg-rose-500 transition-colors whitespace-nowrap disabled:opacity-70 disabled:cursor-not-allowed"
                disabled={isSubscribing}
              >
            ...
            >
              ...
              <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 mb-8">
                <div className="flex items-start space-x-3">
                  <div className="mt-1 rounded-full bg-rose-100 text-rose-600 p-2">
                    <Sparkles className="h-4 w-4" />
                  </div>
                  <div>
                    <h3 className="text-sm font-semibold tracking-wide uppercase">Signature designs</h3>
                    <p className="text-sm text-gray-600">Exclusive pieces you will not find anywhere else, tailored to your personal style.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h3 className="text-sm font-semibold tracking-wide uppercase">Premium quality</h3>
                    <p className="text-sm text-gray-600">Fine fabrics and precise tailoring to ensure comfort, fit, and elegance.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h3 className="text-sm font-semibold tracking-wide uppercase">Flexible choices</h3>
                    <p className="text-sm text-gray-600">Rent, buy, or customize to match your exact occasion and preferences.</p>
                  </div>
                </div>
              </div>
